...
try:    #  get id's  #
    ...
    with open('/home/ihofdomah/key_collectors_project/hot_keys/latest.json') as access_json:
    ...
    if new_id != old_id:
        print('Found update')
        # send_webhook()
        with open("/home/ihofdomah/key_collectors_project/hot_keys/latest.json", "w") as file:            ## WRITE JSON FILE ##
