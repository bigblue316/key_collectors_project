...
try:    #  get id's  #
    ...
    with open('./key_collectors_project/key_alerts_2/latest2.json') as access_json:
    ...
    if new_id != old_id:
        print('Found update')
        send_webhook()
        with open("./key_collectors_project/key_alerts_2/latest2.json", "w") as file:            ## WRITE JSON FILE ##
