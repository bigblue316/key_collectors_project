...
try:    #  get id's  #
    ...
    with open('/home/ihofdomah/key_collectors_project/key_alerts_3/latest3.json') as access_json:
    ...
    if new_id != old_id:
        print('Found update')
        send_webhook()
        with open("/home/ihofdomah/key_collectors_project/key_alerts_3/latest3.json", "w") as file:            ## WRITE JSON FILE ##
    ...
    with open("/home/ihofdomah/key_collectors_project/key_alerts_3/latest3.json", "w") as file:        ## WRITE old JSON FILE ##
        file.write(json.dumps(parsed_json))
