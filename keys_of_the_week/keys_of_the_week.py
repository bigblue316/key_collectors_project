...
try:
    ...
    with open('/home/ihofdomah/key_collectors_project/keys_of_the_week/old_keys.json') as access_json:
    ...
    if new_id != old_id:
        print('Found update')
        send_webhook()
        with open("/home/ihofdomah/key_collectors_project/keys_of_the_week/old_keys.json", "w") as file:        ## WRITE new JSON FILE ##
            file.write(json.dumps(parsed_json))
    else:
        print('No update')

except:
    with open("/home/ihofdomah/key_collectors_project/keys_of_the_week/old_keys.json", "w") as file:        ## WRITE old JSON FILE ##
        file.write(json.dumps(parsed_json))
